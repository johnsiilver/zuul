...
// Resolver maps a replica id to its forwarding address. *consensus.MetaResolver
// satisfies it in production; cluster/topology.Static also satisfies it (used in tests).
