module github.com/johnsiilver/zuul
...
require (
	...
	github.com/gostdlib/base v0.0.0-20260522174845-b347db53abaa
...
require (
	...
	github.com/gostdlib/concurrency v0.0.0-20241230205952-55ea9e292314 // indirect
